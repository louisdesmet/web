...
export const App = ({ getOffices, getSubjects, getSubjectCategories, getCustomers, getContacts, getAppointments, getOutcomes }) => {
  ...
  return (
    <AuthContext.Provider value={{ authTokens, setAuthTokens: setTokens }}>
      <Router>
        ...
        <PrivateRoute path="/outcomes" component={Outcomes} />
        ...
        <PrivateRoute path="/outcome/:id" component={Outcome} />
...
export default connect(
  mapStateToProps,
  { getOffices, getSubjects, getSubjectCategories, getCustomers, getContacts, getAppointments, getOutcomes}
)(App);